...
include("Facebook/autoload.php");
	...
	function __construct()
	{
		...
		$facebook_config=$this->CI->basic->get_data("social_app_facebook_config",array("where"=>array("status"=>"1")));
	...
	function login_for_user_access_token($redirect_url=""){
		...
		return '<a class="btn btn-social btn-block btn-facebook" href="'.htmlspecialchars($loginUrl).'"><span class="fab fa-facebook"></span> <b>ThisIsTheLoginButtonForFacebook</b></a>';	
