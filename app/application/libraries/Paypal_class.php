...
class Paypal_class{
	...
	function set_button(){
		...
		$button.= "<form action='{$this->paypal_url}' method='post' class='paypal_form_action_css'>";
			...
			$button.= "<button type='submit' class='btn btn-warning brn-lg pay_with_paypal_css'><i class='fab fa-paypal'></i> ".$this->CI->lang->line("Pay with PayPal")."</button>";
		$button.= "</form>";	
