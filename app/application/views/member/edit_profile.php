	...
	<div class="section-body">
	  ...
	  <div class="row mt-sm-4">
	        ...
	        <div class="profile-widget-header">
	          ...
	          <div class="profile-widget-items">
	            <div class="profile-widget-item">
	              ...
	              <div class="profile-widget-item-value font_size_12px"><?php echo $email; ?></div>
	            </div>
	            <?php if($this->session->userdata('user_type') != 'Admin') : ?>
		            <div class="profile-widget-item">
		              <div class="profile-widget-item-label"><?php echo $this->lang->line('Package') ?></div>
		              <div class="profile-widget-item-value font_size_12px"><?php echo $package_name; ?></div>
		            </div>
	            <?php endif; ?>
	          </div>
	        </div>
	    ...
	    <div class="col-12 col-md-12 col-lg-7">
	      <div class="card margin_top_35px">
...
<script src="<?php echo base_url('assets/js/system/edit_profile.js');?>"></script>
    ...
    <div class="modal-dialog  modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            	<div id="message_div">
            		<div class="text-center"><i class="fa fa-warning center-block orange font_size_70px"></i></div><br>
            ...
            <div class="modal-footer d_block">
