  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="text-center waiting_spinner_css" id="waiting"><i class="fas fa-spinner fa-spin blue font_size_40px"></i></div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-4">
              <div class="form-group">
                ...
                <?php echo form_dropdown('paid-currency', $currency_list, $currency, ['id' => 'paid-currency', 'class' => 'form-control select2']); ?>
              </div>
            </div>
          </div>          
          ...
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="form-group">
                ...
                <span class="red">pdf, doc, txt, png, jpg, zip</span>
              </div>
            </div>
...
<?php include("application/views/member/buy_package_js.php"); ?>