            ...
            <div class="card-body" id="recovery_form">
              <form class="form-horizontal" action="<?php echo site_url().'home/installation_action';?>" method="POST">
                    ...
                    <div class="form-group text-center">
                      <button type="submit" class="btn btn-primary btn-lg margin_top_20px" <?php if($install_allow == 0) echo "disabled"; ?> ><i class="fa fa-check"></i> Install <?php echo $this->config->item('product_short_name');?> Now</button><br/><br/> 
                    </div>  
                  </form>   
            </div>
          </div>
...
<link rel="stylesheet" href="<?php echo base_url('assets/css/system/install.css');?>">