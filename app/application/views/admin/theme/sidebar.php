...
(
  ...
  base_url("social_accounts/youtube_channel")=>base_url("social_accounts/channel_manager"),
  base_url("responder/auto_like_comment")=>base_url("social_accounts/channel_manager"),
  base_url("responder/auto_channel_subscription")=>base_url("social_accounts/channel_manager"),
  base_url("social_accounts/video_manager")=>base_url("social_accounts/channel_manager"),
  base_url("social_accounts/playlist_manager")=>base_url("social_accounts/channel_manager"),
  base_url("social_accounts/upload_video_list")=>base_url("social_accounts/channel_manager"),
  base_url("social_accounts/upload_video")=>base_url("social_accounts/channel_manager"),
  base_url("social_accounts/channel_analytics")=>base_url("social_accounts"),
  base_url("search_engine/youtube_playlist_video")=>base_url("search_engine/playlist"),
  base_url("responder/auto_reply_template")=>base_url("responder/template_manager"),
  base_url("responder/create_auto_reply_template")=>base_url("responder/template_manager"),
  base_url("responder/edit_auto_reply_template")=>base_url("responder/template_manager"),
  base_url("responder/auto_comment_template")=>base_url("responder/template_manager"),
  base_url("link_wheel/details")=>base_url("link_wheel")
);
