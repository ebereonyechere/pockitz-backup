        ...
        foreach($add_on_list as $value)
        {
          ...
          <div class="col-12 col-sm-6 col-md-4">
            ...
            <div class="card profile-widget">
                ...
                <div class="profile-widget-description padding_bottom_0">
                  <div class="profile-widget-name text-center"><?php echo $value['addon_name'];?></div>
                </div>
                <div class="card-footer text-center padding_top_10">
...
<script src="<?php echo base_url('assets/js/system/addon_manager.js');?>"></script>
...
<link rel="stylesheet" href="<?php echo base_url('assets/css/system/addon_manager.css');?>">