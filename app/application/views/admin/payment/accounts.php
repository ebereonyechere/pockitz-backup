                ...
                <div class="row">
                  <div id="manual-payins" class="col-12">
                    <div class="form-group">
                      ...
                      <textarea name="manual_payment_instruction" class="summernote form-control height_200px"><?php echo set_value('manual_payment_instruction', isset($xvalue['manual_payment_instruction']) ? $xvalue['manual_payment_instruction'] : ""); ?></textarea>
