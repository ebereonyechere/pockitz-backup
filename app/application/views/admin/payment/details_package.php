                ...
                {  
                 $SL++;
                  ...
                  echo "<tr>"; 
                    ...
                    echo "<td align='center'>".$limit."</td><td align='center'><input type='text' ".$disabled." class='form-control width_70px ".$style."' value='".$xmonthly_val."' min='0' name='monthly_".$module['id']."'></td>";
                    ...
                    echo "<td align='center'><input type='text' class='form-control width_70px ".$style."' ".$disabled." value='".$xval."'  min='0' name='bulk_".$module['id']."'></td>";
                  echo "</tr>";                 
                }                
                ?>            
              </table> 
