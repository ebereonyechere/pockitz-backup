             ...
             <div class="form-group" id="hidden">
               <label for="price"><?php echo $this->lang->line("Validity");?> *</label>              
                <div class="row">
                  ...
                  <div class="col-6">
                    <?php echo form_dropdown('validity_type', $validity_type, $validity_type_info, 'class="form-control select2"'); ?>
                  </div>
                </div>
                    ...
                    {  
                     ...
                     echo "<tr>"; 
                        ...
                        if(is_array($current_modules) && in_array($module['id'], $current_modules)) $check_module='checked';  ?>
                          ...
                          if(in_array($module['id'], $mandatory_modules)) $style = "border_color_6777EF cursor_pointer' title='".$this->lang->line('This is a mandatory module and can not be unchecked.')."' data-toggle='tooltip'";

                           echo "<label for='box".$SL."' class='".$style."'></label>";               
                        echo "</td>";
                        ...
                        echo "<td align='center'>".$limit."</td><td align='center'><input type='number' ".$disabled."  class='form-control width_70px ".$style."' value='".$xmonthly_val."' min='0' name='monthly_".$module['id']."'></td>";
                        ...
                        echo "<td align='center'><input type='number'  class='form-control width_70px ".$style."' ".$disabled." value='".$xval."'  min='0' name='bulk_".$module['id']."'></td>";
                      echo "</tr>";                 
                    }                
                    ?>            
                  </table> 
...
<link rel="stylesheet" href="<?php echo base_url('assets/css/system/package_manager.css');?>">
