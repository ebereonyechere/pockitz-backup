<link rel="stylesheet" href="<?php echo base_url('assets/css/system/frontend_settings.css');?>">
							...
							<div class="allReview">
								...
								?>
									  <div class="accordion">
									    ...
									    <div class="accordion-body collapse padding_25px" id="panel-body-<?php echo $i; ?>" data-parent="#accordion">
									      	<div class="row">
											...
											<div class="row">
								          	...
								          	<div class="row">
									           	<div class="col-xs-12 col-md-12">
										           	<div class="form-group">
										             	<label ><i class="fa fa-comment"></i> <?php echo $this->lang->line('Review');?><small class="font_size_12px">&nbsp;</small></label>
		           			...
		           			<div class="extensions">
					            ...
					            ?>
									<div class="accordion">
									  ...
									  <div class="accordion-body collapse padding_25px" id="video-settings-body-<?php echo $i; ?>" data-parent="#accordion-1">
						    			<div class="row">
						    				<div class="col-xs-12 col-md-6">
						    		           	<div class="form-group">
...
<script src="<?php echo base_url('assets/js/system/frontend_settings.js');?>"></script>
