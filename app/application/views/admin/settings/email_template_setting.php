								...
								<div class="card-body">
									<ul class="nav nav-pills flex-column settings_menu">
						    			...
						    			foreach ($emailTemplatetabledata as $value)
						    			{
											...
											<li class="nav-item"><a href="#<?php echo $temp_fildset; ?>" class="nav-link"><i class="<?php echo $value['icon']; ?>"></i> <?php echo $value['title']; ?></a></li>										
						    			<?php 
						    			} ?>							
									</ul>
...
<script src="<?php echo base_url('assets/js/system/email_template_settings.js');?>"></script>