...
<script src="<?php echo base_url('assets/js/system/advertisement_settings.js');?>"></script>
<link rel="stylesheet" href="<?php echo base_url('assets/css/system/advertisement_settings.css');?>">
