    ...
    <div class="card main_card no_shadow">
      <form method="POST" id="video_search_form_data">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
            <label class="d-block"><?php echo $this->lang->line('Published Date'); ?></label>
            <?php echo $drop_menu; ?>
          </div>
    ...
    <div id="middle_column_content" class="bg_ffffff">
      ...
      <div class="col-12 col-sm-6 col-md-6 col-lg-12 bck_clr" id="nodata">
        ...
        <div class="empty-state">
          ...
          <h2 class="mt-0"><?php echo $this->lang->line("Search YouTube channel using the filtering options."); ?></h2>
...
<?php include("application/views/search_engine/channel_search_js.php"); ?>
