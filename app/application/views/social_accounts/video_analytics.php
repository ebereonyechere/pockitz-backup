<section class="section">
	...
	<div class="section-header">
		<h1>
			...
			<?php echo $this->lang->line('Video Analytics'); ?>
		</h1>&nbsp;&nbsp;
		...
		<div class="section-header-breadcrumb">
		  <div class="breadcrumb-item"><a href="<?php echo base_url("social_accounts/channel_manager"); ?>"><?php echo $this->lang->line('Channel Manager'); ?></a></div><div class="breadcrumb-item"><a href="<?php echo base_url("social_accounts/video_manager"); ?>"><?php echo $this->lang->line('Video Manager'); ?></a></div>
		  <div class="breadcrumb-item"><?php echo $this->lang->line('Video Analytics'); ?></div>
		</div>
	</div>
	...
	<div class="section-body">           
		    ...
		    <div class="row">
				<div class="col-12 col-md-6">
                    <h2 class="section-title mt-0" ><a target="_BLANK" href="https://youtube.com/<?php echo isset($video_info[0]['video_id']) ?  $video_info[0]['video_id'] : ""; ?>"><?php echo isset($video_info[0]['title']) ? $video_info[0]['title'] : ""; ?></a></h2>
                    <p class="section-lead">
                      <?php echo isset($video_info[0]['description']) ? $video_info[0]['description'] : ""; ?>
                    </p>
                </div>
                <div class="col-12 col-md-6">
            	...
            	<div class="col-12">
        	        ...
        	        <div class="card">
        	          ...
        	          <div class="card-body">
        	          	...
        	          	<input type="hidden" id="retention_info" value='<?php echo isset($report_data["retention"]) ? $report_data["retention"] : ""; ?>' />
...
<?php include("application/views/social_accounts/video_analytics_js.php"); ?>
