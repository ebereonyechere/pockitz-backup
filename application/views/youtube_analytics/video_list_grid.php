...
<h1> Video list for channel <?php echo $channel_title;?></h1>

</section>
<!-- Main content -->
<?php $channel_id = urlencode($channel_id); ?>
  ...
  <div class="row">
    <div class="col-xs-12">
        <div class="grid_container" style="width:100%; height:1100px;">
            ...
            url="<?php echo base_url()."youtube_analytics/get_channel_video_list_data/".$channel_id; ?>" 
