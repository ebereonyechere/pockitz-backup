<div class="container-fluid">
	<div class="col-xs-12" style="padding-top:20px;">
		<div class="well text-center"><h2 class="red"><?php echo $title; ?></h2></div>
	</div>
	<div class="col-xs-12">
		<div class="col-xs-6">			
			<!-- Date range -->
				...
				<div class="row">
					<div class="col-xs-12 col-sm-12 col-md-6">
						<div class="row">
							...
							<div class="col-xs-12"><div class="well text-center">The statistics gender on channel</div></div>
					...
					<div class="col-xs-12 col-sm-12 col-md-6">
						<div class="row">
							...
							<div class="col-xs-12"><div class="well text-center">The statistics age group on channel</div></div>
							<div class="col-md-8 col-xs-12">
	...
	<div class="col-xs-12" style="padding-top:20px;">
		...
		<div class="box box-primary">
			<div class="box-header with-border">
			<h3 class="box-title" style="color: #3C8DBC; word-spacing: 4px;"> Video Added Vs Removed From Playllist From <?php echo $from_date; ?> To <?php echo $to_date; ?></h3>
				<div class="box-tools pull-right">
					<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
					<button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
				</div>
			...
			<div class="box-body">
				<div class="well text-center">The number of times that videos were added to any and removed from any YouTube playlists</div>
				<input type="hidden" id="video_added_vs_removed" value='<?php echo $video_added_vs_removed; ?>' />
				<div class="chart">
					<div class="chart" id="video_added_vs_removed_line_chart" style="height: 300px;"></div>
				</div>
			</div><!-- /.box-body -->
		</div><!-- /.box -->
	</div>
...
<script>
	...
	$j("document").ready(function(){
		...
		$("#search").click(function(){
			...
			var link="<?php echo site_url('youtube_analytics/get_individual_channel_info'); ?>"+"/"+table_id+"/"+start_date+"/"+end_date; 
	 ...
	 //    });
	    ...
	    // LINE CHART
		var video_added_vs_removed = $('#video_added_vs_removed').val();
	    var line = new Morris.Bar({
	      element: 'video_added_vs_removed_line_chart',
	      resize: true,
	      data: JSON.parse(video_added_vs_removed),
	      xkey: 'date',
	      ykeys: ['added','removed'],
	      labels: ['Video Added To Playllist','Video Removed From Playllist'],
	      barColors: ['#FF9900','#FF0000'],
	      lineWidth: 1,
	      hideHover: 'auto'
	    });
