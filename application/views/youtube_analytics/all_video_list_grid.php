    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h1 class="card-title">Video list for all channel</h1>
            </div>
                    ...
                    <div id="tb" style="padding:3px">
                        ...
                        <form class="form-inline" style="margin-top:20px">
                            ...
                            <div class="form-group">
                                <input id="video_title" name="video_title" class="form-control" size="20"
                                       placeholder="Video Title">
                            </div>

                            <button class='btn btn-info'
                                    onclick="doSearch(event)"><?php echo $this->lang->line("search"); ?></button>
