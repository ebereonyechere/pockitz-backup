...
<section class="content-header">
	<h1 class = 'text-info'><?php echo $this->lang->line("Google Video Tracking Settings");?> </h1>
</section>
	...
	<div class="row" >
		<div class="col-xs-12">
			<div class="grid_container" style="width:100%; min-height:500px;">
				...
				url="<?php echo base_url()."video_position_tracking/google_keyword_list_data"; ?>" 
				...
				>
					...
					<thead>
						<tr>
							...
							<th field="website" sortable="true"><?php echo $this->lang->line("Video Link")?></th>
			...
			<a style="margin-bottom: 5px;" class="btn btn-warning"  title="<?php echo $this->lang->line("add"); ?>" href="<?php echo site_url('video_position_tracking/google_tracking_settings');?>">
...
<script>
    ...
    {               
        var delete_url=base_url+'video_position_tracking/google_delete_keyword_action/'+row.id;
