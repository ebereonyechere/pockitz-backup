	...
	?>
		<div class="card">
			<div class="card-header">
				<h3 class="card-title"><i class="fa fa-plus-circle"></i> <?php echo $this->lang->line("add")." - ".$this->lang->line("keyword"); ?></h3>
			</div><!-- /.box-header -->
            <div class="card-content">
                <div class="card-body">

                    <form class="form-horizontal" action="<?php echo site_url().'video_position_tracking/google_tracking_settings_action';?>" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-6 col-lg-6">
                                ...
                                echo form_dropdown('country',$country_name,set_value('country'),' style="width:100%" class="form-control" id="country"');
                                ?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-md-6 col-lg-6">
                                ...
                                echo form_dropdown('language',$language_name,set_value('language'),' style="width:100%" class="form-control" id="language"');
                                ?>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                                <div class="col-sm-12 text-center">
                                    ...
                                    <input type="button" class="btn btn-default btn-lg" value="<?php echo $this->lang->line("cancel");?>" onclick='goBack("video_position_tracking/google_keyword_list")'/>
                                </div>
                            </div>
                        </div><!-- /.box-footer -->
                    </form>
