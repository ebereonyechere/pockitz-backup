	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<h3 class="card-title"><i class="fa fa-plus-square"></i> Create a new event to your youtube channel</h3>
			</div><!-- /.box-header -->
                ...
                <div class="box-footer">
                    <div class="form-group">
                        <div class="col-sm-12 text-center">
                            <input name="submit" id="submit" type="button" class="save btn btn-primary btn-lg" value="<?php echo $this->lang->line("save");?>"/>
