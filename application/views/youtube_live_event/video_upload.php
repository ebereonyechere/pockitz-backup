<!--<script src="--><?php //echo base_url(); ?><!--new_ui/datetimepicker/jquery.datetime" type="text/javascript"></script>-->
<?php
	...
	<div class="col-md-12">
		<div class="card">
			...
			<div class="card-header">
				<h3 class="card-title"><i class="fa fa-cloud-upload"></i> Upload a video to your youtube channel</h3>
			</div><!-- /.box-header -->
                    ...
                    <form class="form-horizontal" action="<?php echo site_url().'youtube_live_event/youtube_video_upload_action';?>" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="well"><b>Format :  mov/mpeg4/mp4/avi/wmv/mpegps/flv/3gpp/webm</div>
                            </div>
                        </div>
