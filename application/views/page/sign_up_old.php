				...
				<div>
	  			...
	  			<form class="form-horizontal" method="post" action="<?php echo site_url('home/sign_up_action'); ?>">
					...
					<div class="form-group">
	  				...
	  				<div class="form-group">
	  					<div class="col-xs-12">
	  						<center><a data-toggle="modal" href='#modal-id'><?php echo $this->lang->line("by clicking Sigh Up, you agree to the terms and conditions set out by this site");?></a></center>
