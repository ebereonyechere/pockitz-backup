...
<style>#recovery_form{text-align:center;}</style>
  ...
  <div class="col-sm-12 col-xs-12 col-md-5 col-lg-5 border_gray grid_content padded background_white alert alert-warning">
      ...
      <div class="alert alert-warning">
        <p>Please make sure that the following folders (and child files)  or files have write permission (777 or 755)</p>
        <p>
          <ul>
            <li>Folder : application/config</li>
            <li>Folder : application/core</li>
            <li>Folder : upload</li>
            <li>Folder : download</li>
            <li>File : application/install.txt</li>
          </ul>
        </p>
      </div>
