			...
			<div class="grid_container well table-responsive" style="width:auto;background:#fff;border:1px solid #ccc;padding:20px">
				<h3 class='text-center'>
					<div class="well">			
					   ...
					   <?php echo $this->lang->line("expiry date");?> : <?php echo date("j M Y",strtotime($this->session->userdata("expirydate"))); ?>			
					</div>
				</h3>	
	               		...
	               		<tr class="warning">
	               	 	...
	               	 	foreach($info as $row)
	               	 	{
		               	 	...
		               	 	echo "<tr>";
			               	 	...
			               	 	if(in_array($row["module_id"], array()))
			               	 	{
			               	 	...
			               	 	echo "<td class='text-center'>";
			               	 		...
			               	 		else
			               	 		{
			               	 			...
			               	 			else $monthly_limit[$row["module_id"]]=$monthly_limit[$row["module_id"]]." ".$row["extra_text"];
