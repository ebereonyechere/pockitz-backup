   ...
   <div class="col-md-12">
     <div class="card">
       <div class="card-header">
         <h3 class="card-title"><i class="fa fa-plus-pencil"></i> <?php echo $this->lang->line("edit")." - ".$this->lang->line("package settings"); ?></h3>
       </div><!-- /.box-header -->
                         ...
                         <div class="col-sm-9 table-responsive">
                             ...
                             <table class="table table-bordered table-condensed table-hover table-striped" style="width:auto;">
                                 ...
                                 foreach($modules as $module)
                                 {
                                     echo "<tr>";
                                     echo "<td>";
                                     if((is_array($current_modules) && in_array($module['id'], $current_modules)) || $module['id']==33)
                                     { ?>
