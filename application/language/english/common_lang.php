...
array (
  ...
  "start scanning" => "Start Scanning",
    ...
    "Channel Search Engine" => "Channel Search Engine",
    "Playlist Search Engine" => "Playlist Search Engine",
    "Import Channel & Video" => "Import Channel & Video",
    "Channel Analytics" => "Channel Analytics",
    "Video Analytics" => "Video Analytics",
    "Scheduled Video Uploader" => "Scheduled Video Uploader",
    "Keyword Scraper" => "Keyword Scraper",
    ...
    "type any keyword" => "type any keyword",
    "limit" => "limit",
    "order" => "order",
