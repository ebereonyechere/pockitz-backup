...
class config extends Home
{
    ...
    */
    public function configuration()
    {
        ...
        $data['is_admin'] = $this->session->userdata("user_type") == "Admin" ? true : false;
    ...
    public function edit_config()
    {
        ...
        if ($_POST) 
        {
            ...
            else 
            {
                ...
                if($this->basic->is_exist("config",$where=array("user_id"=>$this->session->userdata("user_id")),$select='id') && $this->session->userdata("user_type") != "Admin")
