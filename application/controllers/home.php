...
class home extends CI_Controller
{
    ...
    */
    ...
    public function login_page($is_signup = false)
    {
    ...
    */
    ...
    public function sign_up_action()
    {
        ...
        if($_POST) {
            ...
            $this->form_validation->set_rules('email', '<b>'.$this->lang->line("email").'</b>', 'trim|required|xss_clean|valid_email');
            ...
            else 
            {
                ...
                if(file_exists(APPPATH.'core/licence_type.txt'))
                {
                    ...
                    $where = array();
                    if($license_type != 'double')
                        $where['where'] = array('email' => $email, "deleted" => "0","status"=>"1", 'id'=>1);
                    else
...
//                    $package_id=$default_package[0]["id"];
                        ...
                        $data = array(
                            ...
                            'expired_date'=>'2222-10-25 00:00:00',
                            'package_id'=>$package_id
                        );

                        if ($this->basic->insert_data('users', $data)) {
//                            $this->dd('hello');
                            return $this->login_page(true);
                            //email to user
...
//                            return $this->sign_up();
                    ...
                    if ($this->basic->update_data('users', $where, $data)) {
