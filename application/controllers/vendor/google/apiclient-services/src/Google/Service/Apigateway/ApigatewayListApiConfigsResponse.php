...
class Google_Service_Apigateway_ApigatewayListApiConfigsResponse extends Google_Collection
{
  protected $collection_key = 'unreachableLocations';
  protected $apiConfigsType = 'Google_Service_Apigateway_ApigatewayApiConfig';
