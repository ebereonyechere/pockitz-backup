...
class Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaListAndroidAppDataStreamsResponse extends Google_Collection
{
  protected $collection_key = 'androidAppDataStreams';
  protected $androidAppDataStreamsType = 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaAndroidAppDataStream';
