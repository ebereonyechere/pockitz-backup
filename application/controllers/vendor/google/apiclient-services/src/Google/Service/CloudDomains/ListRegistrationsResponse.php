...
class Google_Service_CloudDomains_ListRegistrationsResponse extends Google_Collection
{
  protected $collection_key = 'registrations';
  public $nextPageToken;
  protected $registrationsType = 'Google_Service_CloudDomains_Registration';
