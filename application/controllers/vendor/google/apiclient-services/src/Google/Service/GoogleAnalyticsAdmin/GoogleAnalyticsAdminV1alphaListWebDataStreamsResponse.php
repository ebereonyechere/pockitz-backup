...
class Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaListWebDataStreamsResponse extends Google_Collection
{
  protected $collection_key = 'webDataStreams';
  public $nextPageToken;
  protected $webDataStreamsType = 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaWebDataStream';
