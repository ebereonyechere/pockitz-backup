...
class Google_Service_Apigateway_ApigatewayOperationMetadata extends Google_Collection
{
  protected $collection_key = 'diagnostics';
  public $apiVersion;
  public $createTime;
  protected $diagnosticsType = 'Google_Service_Apigateway_ApigatewayOperationMetadataDiagnostic';
