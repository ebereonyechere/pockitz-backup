 ...
 *  </code>
 */
class Google_Service_Assuredworkloads_Resource_OrganizationsLocationsOperations extends Google_Service_Resource
{
  /**
  ...
  public function get($name, $optParams = array())
  {
    ...
    return $this->call('get', array($params), "Google_Service_Assuredworkloads_GoogleLongrunningOperation");
  }
  /**
  ...
  public function listOrganizationsLocationsOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Assuredworkloads_GoogleLongrunningListOperationsResponse");
  }
}
