 ...
 * @author Google, Inc.
 */
class Google_Service_SmartDeviceManagement extends Google_Service
{
  ...
  public function __construct(Google_Client $client, $rootUrl = null)
  {
    ...
    $this->enterprises_devices = new Google_Service_SmartDeviceManagement_Resource_EnterprisesDevices(
        $this,
        $this->serviceName,
        'devices',
        array(
    ...
    $this->enterprises_structures = new Google_Service_SmartDeviceManagement_Resource_EnterprisesStructures(
        $this,
        $this->serviceName,
        'structures',
        array(
    ...
    $this->enterprises_structures_rooms = new Google_Service_SmartDeviceManagement_Resource_EnterprisesStructuresRooms(
        $this,
        $this->serviceName,
        'rooms',
        array(
