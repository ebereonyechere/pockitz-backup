...
class Google_Service_Bigquery_ListRowAccessPoliciesResponse extends Google_Collection
{
  protected $collection_key = 'rowAccessPolicies';
  public $nextPageToken;
  protected $rowAccessPoliciesType = 'Google_Service_Bigquery_RowAccessPolicy';
