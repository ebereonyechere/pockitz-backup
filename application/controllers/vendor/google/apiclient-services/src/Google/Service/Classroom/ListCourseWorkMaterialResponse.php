...
class Google_Service_Classroom_ListCourseWorkMaterialResponse extends Google_Collection
{
  protected $collection_key = 'courseWorkMaterial';
  protected $courseWorkMaterialType = 'Google_Service_Classroom_CourseWorkMaterial';
