...
class Google_Service_CloudBillingBudget_GoogleCloudBillingBudgetsV1ListBudgetsResponse extends Google_Collection
{
  protected $collection_key = 'budgets';
  protected $budgetsType = 'Google_Service_CloudBillingBudget_GoogleCloudBillingBudgetsV1Budget';
