...
class Google_Service_Document_GoogleCloudDocumentaiV1beta3BoundingPoly extends Google_Collection
{
  protected $collection_key = 'vertices';
  protected $normalizedVerticesType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3NormalizedVertex';
  protected $normalizedVerticesDataType = 'array';
  protected $verticesType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3Vertex';
