 ...
 * Typical usage is:
 *  <code>
 *   $customsearchService = new Google_Service_CustomSearchAPI(...);
 *   $siterestrict = $customsearchService->siterestrict;
 *  </code>
 */
class Google_Service_CustomSearchAPI_Resource_CseSiterestrict extends Google_Service_Resource
{
  /**
   ...
   * filtering. (default)
   * @return Google_Service_CustomSearchAPI_Search
   */
  public function listCseSiterestrict($optParams = array())
  {
    $params = array();
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_CustomSearchAPI_Search");
  }
}
