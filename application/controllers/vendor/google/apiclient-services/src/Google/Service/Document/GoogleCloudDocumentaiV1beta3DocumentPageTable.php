...
class Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageTable extends Google_Collection
{
  protected $collection_key = 'headerRows';
  protected $bodyRowsType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow';
  ...
  protected $headerRowsType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageTableTableRow';
