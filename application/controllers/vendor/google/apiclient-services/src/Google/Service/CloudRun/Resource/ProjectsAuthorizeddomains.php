 ...
 *  </code>
 */
class Google_Service_CloudRun_Resource_ProjectsAuthorizeddomains extends Google_Service_Resource
{
  /**
   ...
   */
  public function listProjectsAuthorizeddomains($parent, $optParams = array())
  {
