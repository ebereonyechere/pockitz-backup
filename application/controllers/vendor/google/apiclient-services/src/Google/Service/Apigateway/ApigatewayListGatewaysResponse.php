...
class Google_Service_Apigateway_ApigatewayListGatewaysResponse extends Google_Collection
{
  protected $collection_key = 'unreachableLocations';
  protected $gatewaysType = 'Google_Service_Apigateway_ApigatewayGateway';
