...
class Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageFormField extends Google_Collection
{
  protected $collection_key = 'valueDetectedLanguages';
  protected $fieldNameType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageLayout';
  protected $fieldNameDataType = '';
  protected $fieldValueType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageLayout';
  protected $fieldValueDataType = '';
  protected $nameDetectedLanguagesType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage';
  protected $nameDetectedLanguagesDataType = 'array';
  protected $valueDetectedLanguagesType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageDetectedLanguage';
   ...
   */
  public function setFieldName(Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageLayout $fieldName)
  {
   ...
   * @param Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageLayout
   */
  public function setFieldValue(Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageLayout $fieldValue)
  {
