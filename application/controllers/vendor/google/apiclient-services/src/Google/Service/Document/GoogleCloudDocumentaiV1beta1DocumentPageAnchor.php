...
class Google_Service_Document_GoogleCloudDocumentaiV1beta1DocumentPageAnchor extends Google_Collection
{
  protected $collection_key = 'pageRefs';
  protected $pageRefsType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta1DocumentPageAnchorPageRef';
