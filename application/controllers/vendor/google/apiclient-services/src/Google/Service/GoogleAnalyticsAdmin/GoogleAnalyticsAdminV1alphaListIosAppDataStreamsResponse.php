...
class Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaListIosAppDataStreamsResponse extends Google_Collection
{
  protected $collection_key = 'iosAppDataStreams';
  protected $iosAppDataStreamsType = 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1alphaIosAppDataStream';
