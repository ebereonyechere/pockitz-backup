...
class Google_Service_CustomSearchAPI_SearchQueries extends Google_Collection
{
  protected $collection_key = 'request';
  protected $nextPageType = 'Google_Service_CustomSearchAPI_SearchQueriesNextPage';
  protected $nextPageDataType = 'array';
  protected $previousPageType = 'Google_Service_CustomSearchAPI_SearchQueriesPreviousPage';
  protected $previousPageDataType = 'array';
  protected $requestType = 'Google_Service_CustomSearchAPI_SearchQueriesRequest';
