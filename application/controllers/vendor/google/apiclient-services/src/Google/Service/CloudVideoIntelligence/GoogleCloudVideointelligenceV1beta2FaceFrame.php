...
class Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1beta2FaceFrame extends Google_Collection
{
  protected $collection_key = 'normalizedBoundingBoxes';
  protected $normalizedBoundingBoxesType = 'Google_Service_CloudVideoIntelligence_GoogleCloudVideointelligenceV1beta2NormalizedBoundingBox';
