...
class Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageToken extends Google_Collection
{
  protected $collection_key = 'detectedLanguages';
  protected $detectedBreakType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak';
  ...
  /**
   * @param Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak
   */
  public function setDetectedBreak(Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak $detectedBreak)
  {
    $this->detectedBreak = $detectedBreak;
  }
  /**
   * @return Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentPageTokenDetectedBreak
   */
