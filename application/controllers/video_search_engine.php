        ...
        foreach ($final_data as $value)
        {
           if(isset($value["items"]))
           {
             foreach ($value["items"] as $row) 
             {
                ...
                $download_url="https://www.ssyoutube.com/embed/{$id}?rel=0&wmode=transparent&autoplay=1";
                 $download_url = "https://keepv.id?url=https://www.youtube.com/watch?v={$id}";
                ...
                $download_video="<a style='margin-top:7px;padding:3px;font-size:12px' class='btn btn-warning' href='{$download_url}' target='_BLANK'><i class='fa fa-download'></i> Download</a>";
